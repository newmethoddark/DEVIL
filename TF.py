...
TOKEN = '8126841707:AAEx16Yef7P6-GSNGGdJQEjE-slsVFgBdoU'  # Replace with your actual bot token
ADMIN_IDS = [7210717311]  # Added new admin ID
CHANNEL_ID = '-1002339903795'  # Replace with your specific channel or group ID
# Initialize the bot
...
COOLDOWN_DURATION = 150  # 4 minutes
...
EXEMPTED_USERS = [6768273586, 7210717311]
...
def welcome_start(message):
    ...
    bot.send_message(
            message.chat.id,
            f"👋🏻Welcome {user_name}.\n\n"
            f"[➖ 𝗖𝗟𝗜𝗖𝗞 𝗛𝗘𝗥𝗘 𝗧𝗢 𝗝𝗢𝗜𝗡 ➖](https://t.me/+JvJYyNHKTbw3Zjc1)\n\n"    
    ...
    bot.send_message(
            message.chat.id,
            f"↘️                                                       ↙️\n\n     [➖𝗗𝗠 𝗙𝗢𝗥 𝗥𝗘𝗕𝗥𝗔𝗡𝗗𝗜𝗡𝗚➖](https://t.me/DARKVIPDDOSX)\n\n↗️                                                       ↖️",
    parse_mode="Markdown",
    disable_web_page_preview=True  # This disables the link preview
    )
...
# 🔄 『 𝑹𝒆𝒔𝒆𝒕 𝑨𝒕𝒕𝒂𝒄𝒌 𝑳𝒊𝒎𝒊𝒕𝒔 』🔄
@bot.message_handler(commands=['reset_DK'])
def reset_attack_limit(message):
    owner_id = 7210717311  # Replace with the actual owner ID
    ...
    response = (
        ...
        "━━━━━━━━━━━━━━━━━━━\n"
        "🔗 *𝗣𝗢𝗪𝗘𝗥𝗘𝗗 𝗕𝗬: [𝘿𝘼𝙍𝙆_𝙊𝙒𝙉𝙀𝙍]('https://t.me/DARKVIPDDOSX') ⚡*"
    )
...
FEEDBACK_CHANNEL_ID = "-1002342633701"  # Replace with your actual feedback channel ID
...
def bgmi_command(message):
    ...
    try:
        ...
        if user_status not in ["member", "administrator", "creator"]:
            bot.send_message(
                message.chat.id,
                " *‼️𝗗𝗔𝗥𝗞 𝗙𝗥𝗘𝗘 𝗗𝗗𝗢𝗦™ 𝗔𝗖𝗖𝗘𝗦𝗦 𝗗𝗘𝗡𝗜𝗘𝗗‼️* \n\n"
    ...
    try:
        ...
        logging.info(f"Attack started by {user_name}: ./LULLI {target_ip} {target_port} {default_duration} 200")
